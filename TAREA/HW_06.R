...
#Realizar las estadísticas descriptivas de ambas variables (media, desviaciÃ³n estÃ¡ndar y varianza)
...
# ¿Cuál es el coeficiente de correlaciÃ³n (r)?
...
#RegresiÃ³n lineal___________________________________________________________________________________________________


#Establecer la HipÃ³tesis nula
#La hipotesis es nula ya que existe una correlacion y su valor de p es mayor a 0.05

#Establecer la HipÃ³tesis alternativa
...
# ¿Cuál será la duración en minutos de la próxima erupción, si los tiempo de espera son los dados en el siguiente cuadro?
